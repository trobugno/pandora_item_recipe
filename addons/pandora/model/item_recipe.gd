class_name PandoraItemRecipe extends RefCounted
...
func get_item_entity() -> ItemEntity:
	return _reference.get_entity() as ItemEntity
...
func _to_string() -> String:
	return "<PandoraItemRecipe" + str(get_item_entity()) + ">"
